...
const testimonials = [
  {
    ...
    name: 'Jamie R.',
    image: restaurant,
    review: 'The atmosphere was warm and welcoming, and the food felt fresh, vibrant, and full of character.'
  },
  {
    title: 'Fresh Favorites',
    name: 'Avery T.',
    image: chefB,
    review: 'Every dish tasted thoughtful and well prepared, from the appetizers to the final dessert.'
  },
  {
    title: 'Family Favorite',
    name: 'Taylor M.',
    image: marioA,
    review: 'We loved the lively energy and the quality of the ingredients. It feels like a true neighborhood gem.'
  },
  {
    title: 'Top Spot',
    name: 'Jordan P.',
    image: marioB,
    review: 'Friendly service, bold flavors, and a memorable dining experience from start to finish.'
  }
];
          ...
          {testimonials.map((item) => (
            <article className="testimonial-card" key={item.name}>
              ...
              <div className="testimonial-card__profile-row">
                <img className="testimonial-card__avatar" src={item.image} alt={item.name} />
                <h2>{item.name}</h2>
              </div>
